...
class CreateTaskController {
    ...
    async init() {
        try {
            ...
            // DİKKAT: Buradaki await loadSharedLayout(...) satırını SİLDİK!
    ...
    _searchPortfolioLocal(term) {
        ...
        const typeId = String(this.state.selectedTaskType?.id || '');
        const isThirdPartyOnly = ['1', '20', TASK_IDS.ITIRAZ_YAYIN].includes(typeId);
        // 🔥 YENİ: Marka İptal Talebi için üçüncü taraf dosyalarının da aranmasına izin verildi!
        const allowThirdPartyMixed = ['19', '8', '21', '37', '38', TASK_IDS.YAYIMA_ITIRAZIN_YENIDEN_INCELENMESI, TASK_IDS.KARARA_ITIRAZ_GERI_CEKME, TASK_IDS.YAYINA_ITIRAZI_GERI_CEKME, TASK_IDS.MARKA_IPTAL_TALEBI].includes(typeId);
...
// 🔥 YENİ: Sayfa HTML'i tamamen hazır olduğunda menüyü ve modülü güvenle başlat
document.addEventListener('DOMContentLoaded', () => {
    // 1. Sol menüyü ve üst barı yükle
